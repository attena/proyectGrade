...
<div class="alert alert-success alert-dismissible fade show  save-poll mt-4 d-none" role="alert">
...
<form class="form-questions mt-4" id="form-questions" method="post">
            ...
            <div class="card border-0 mb-4" style="border-radius: 20px;box-shadow: 0px 0px 7px 0px #ddd;">
                <div class="card-body">
                    <div class="form-group mb-2">
                        <input type="text" class="form-control custom-input-title" require id="title" name="title" required placeholder="Título de la encuesta">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body pt-4">
                    <div class="row">
                        <div class="form-group mb-0 col-lg-8">
                            <input type="text" class="form-control custom-input" require id="spanish_statement" name="question[]" placeholder="Ingresa la pregunta">
